...
const projects = {
  ...
  gtfs: {
    ...
    summary: "Integración y estandarización de datos de transporte público para la generación del GTFS y sistemas predictivos.",
  ...
  bariloche: {
    ...
    summary: "Relevamiento urbano y diagnóstico conceptual para mejorar la movilidad y calidad del espacio público.",
  ...
  ign: {
    ...
    summary: "Definición de criterios cartográficos y actualización de mapas base para Argenmap. Publicación de información geoespacial.",
  ...
  ide: {
    ...
    summary: "Modernización y estructuración de la información geoespacial para mejorar calidad de datos y autonomía en la gestión.",
  ...
  indicadores: {
    ...
    place: "Ministerio de Infraestructura y Desarrollo Territorial · Mendoza",
    summary: "Integración y estructuración de normativa urbana y zonificación en un visualizador GIS para gestión territorial.",
...
function openProject(key) {
  ...
  document.getElementById("modal-place").innerText    = project.place;
  ...
  if (project.link) {
    linkContainer.innerHTML = `<a href="${project.link}" target="_blank" rel="noopener">Ver proyecto →</a>`;
